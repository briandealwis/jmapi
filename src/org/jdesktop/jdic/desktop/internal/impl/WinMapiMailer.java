...
import jmapi.MailerService;
import jmapi.Message;
...
public class WinMapiMailer implements MailerService {
    ...
    public void open(Message msg) throws LaunchFailedException {
        String[] toArray = ItrToStringArray(msg.getToAddrs().iterator());
        String[] ccArray = ItrToStringArray(msg.getCcAddrs().iterator());
        String[] bccArray = ItrToStringArray(msg.getBccAddrs().iterator());
        String[] attachArray = ItrToStringArray(msg.getAttachments().iterator());
